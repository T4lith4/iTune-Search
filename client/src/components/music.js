    ...
    return (
      <div className="container">
         <h4 className="welcome-text">
          Add music to your favorite list by clicking on the "Add as Favorite"
          button <br />
          <br />
        ...
        <img
          src={loader}
          className={`search-loading ${loading ? "show" : "hide"}`} //loader icon displays while search results are loading
          alt="loader"
        />
        ...
        <br />
        <PageNavigation
          className="page-nav" //Previous and Next Page Navigation
          loading={loading}
